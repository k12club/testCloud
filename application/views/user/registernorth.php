			...
			<div class="row main">
				...
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h1 class="title" >Register Northbankkok University Form</h1>
	               		<hr />
	               	</div>
	            </div> 
				<div class="main-login main-center">
					<form role="form" action="<?php echo base_url('user/new_user'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">ชื่อจริง</label>
						...
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">นามสกุลจริง</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
						...
						<div class="form-group">
							<label for="password" class="cols-sm-2 control-label">ช่องทางการติดต่อ Facebook,Line,Instargram</label>
							<div class="cols-sm-10">
								<div class="input-group">
